...
func (sc *SessionCreate) SetExpiryAt(i int64) *SessionCreate {
	sc.mutation.SetExpiryAt(i)
	return sc
}
...
func (sc *SessionCreate) check() error {
	...
	if _, ok := sc.mutation.ExpiryAt(); !ok {
		return &ValidationError{Name: "expiryAt", err: errors.New(`ent: missing required field "Session.expiryAt"`)}
	}
...
func (sc *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.ExpiryAt(); ok {
