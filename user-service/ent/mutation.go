...
func (m *SessionMutation) SetExpiryAt(i int64) {
	m.expiryAt = &i
	m.addexpiryAt = nil
}

// ExpiryAt returns the value of the "expiryAt" field in the mutation.
func (m *SessionMutation) ExpiryAt() (r int64, exists bool) {
	v := m.expiryAt
	if v == nil {
		return
	}
...
// OldExpiryAt returns the old "expiryAt" field's value of the Session entity.
// If the Session object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SessionMutation) OldExpiryAt(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SessionMutation) AddExpiryAt(i int64) {
	if m.addexpiryAt != nil {
		*m.addexpiryAt += i
	} else {
		m.addexpiryAt = &i
	}
...
// AddedExpiryAt returns the value that was added to the "expiryAt" field in this mutation.
func (m *SessionMutation) AddedExpiryAt() (r int64, exists bool) {
	v := m.addexpiryAt
	if v == nil {
		return
	}
...
// ResetExpiryAt resets all changes to the "expiryAt" field.
func (m *SessionMutation) ResetExpiryAt() {
	m.expiryAt = nil
	m.addexpiryAt = nil
}
...
func (m *SessionMutation) Fields() []string {
	...
	if m.expiryAt != nil {
		fields = append(fields, session.FieldExpiryAt)
	}
	return fields
}
