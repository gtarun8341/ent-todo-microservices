...
// ExpiryAt applies equality check predicate on the "expiryAt" field. It's identical to ExpiryAtEQ.
func ExpiryAt(v int64) predicate.Session {
	return predicate.Session(sql.FieldEQ(FieldExpiryAt, v))
}
...
// ExpiryAtEQ applies the EQ predicate on the "expiryAt" field.
func ExpiryAtEQ(v int64) predicate.Session {
	return predicate.Session(sql.FieldEQ(FieldExpiryAt, v))
}

// ExpiryAtNEQ applies the NEQ predicate on the "expiryAt" field.
func ExpiryAtNEQ(v int64) predicate.Session {
	return predicate.Session(sql.FieldNEQ(FieldExpiryAt, v))
}

// ExpiryAtIn applies the In predicate on the "expiryAt" field.
func ExpiryAtIn(vs ...int64) predicate.Session {
	return predicate.Session(sql.FieldIn(FieldExpiryAt, vs...))
}

// ExpiryAtNotIn applies the NotIn predicate on the "expiryAt" field.
func ExpiryAtNotIn(vs ...int64) predicate.Session {
	return predicate.Session(sql.FieldNotIn(FieldExpiryAt, vs...))
}

// ExpiryAtGT applies the GT predicate on the "expiryAt" field.
func ExpiryAtGT(v int64) predicate.Session {
	return predicate.Session(sql.FieldGT(FieldExpiryAt, v))
}

// ExpiryAtGTE applies the GTE predicate on the "expiryAt" field.
func ExpiryAtGTE(v int64) predicate.Session {
	return predicate.Session(sql.FieldGTE(FieldExpiryAt, v))
}

// ExpiryAtLT applies the LT predicate on the "expiryAt" field.
func ExpiryAtLT(v int64) predicate.Session {
	return predicate.Session(sql.FieldLT(FieldExpiryAt, v))
}

// ExpiryAtLTE applies the LTE predicate on the "expiryAt" field.
func ExpiryAtLTE(v int64) predicate.Session {
	return predicate.Session(sql.FieldLTE(FieldExpiryAt, v))
}
